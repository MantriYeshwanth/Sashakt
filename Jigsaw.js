...
const Jigsaw = () => {
  ...
  return (
    <div style={{ margin: '80px auto', display: 'grid', padding: '0 10px', gridTemplateColumns: 'repeat(2, 1fr)', marginBottom: '10px', gridColumnGap: '95px', maxWidth: '1100px' }}>

      <div style={{ borderWidth: '2px', borderStyle: 'solid', borderColor: '#cdbebe', marginLeft: '30px' ,width:'50vw',height:"50vh"}}>
        <JigsawPuzzle
